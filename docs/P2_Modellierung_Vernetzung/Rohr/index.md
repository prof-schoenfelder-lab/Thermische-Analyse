...
-   <a class="card-link" href="01-material/">
    ...
    <figure style="text-align:center;"><img src="../images/rohr_05-Bsp1a.png" width="260" class="no-lightbox"></figure>
    </a>

-   <a class="card-link" href="b-viertelmodell/">
    __b) Viertelmodell (3D)__ — Abstraktion per Symmetrie
    <figure style="text-align:center;"><img src="../images/rohr_05-Bsp1b.png" width="260" class="no-lightbox"></figure>
    </a>

-   <a class="card-link" href="c-rotationssymmetrie/">
    __c) Rotationssymmetrie (2D)__ — Abstraktion per Dimensionsreduktion
    <figure style="text-align:center;"><img src="../images/rohr_05-Bsp1c.png" width="260" class="no-lightbox"></figure>
    </a>
